...
<p align="center">
  <a href="https://devtools.at/tools/jsonpath-tester"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Test JSONPath expressions</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/jsonpath-tester">Try Online</a> •
...
**[Try JSONPath Tester online at DevTools.at →](https://devtools.at/tools/jsonpath-tester)**
...
Test JSONPath expressions. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/jsonpath-tester';
